...
public class PageFragment1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ViewGroup rootView = (ViewGroup)inflater
                .inflate(R.layout.monday, container
                        ,false);
        ...
        ListAdapter myAdapter1 = new MyAdapter(getActivity(), mTime1, mLesson1, mTeacher1, mCabinet1, mTypeless1);
        if(myAdapter1.isEmpty()){
            TextView tv = rootView.findViewById(R.id.empty1);
            tv.setVisibility(View.VISIBLE);
        }
        ListAdapter myAdapter2 = new MyAdapter(getActivity(), mTime2, mLesson2, mTeacher2, mCabinet2, mTypeless2);
